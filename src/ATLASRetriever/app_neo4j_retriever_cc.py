...
async def startup():
    ...
    largekg_retriever = load_api_start_up(sentence_encoder, llm_generator, "cc_en")
...
class ChatCompletionRequest(BaseModel):
    ...
    knowledge_graph: Optional[str] =  "cc_en"
...
if __name__ == "__main__":
    uvicorn.run("app_neo4j_retriever_cc:app", host="0.0.0.0", port=10089, reload=False)

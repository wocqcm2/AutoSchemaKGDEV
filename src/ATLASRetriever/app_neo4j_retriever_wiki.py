...
async def startup():
    ...
    hipporag2_retriver = load_api_start_up(sentence_encoder, llm_generator, "en_simple_wiki_v0")
...
class ChatCompletionRequest(BaseModel):
    ...
    knowledge_graph: Optional[str] =  "en_simple_wiki_v0"
...
if __name__ == "__main__":
    uvicorn.run("app_neo4j_retriever_wiki:app", host="0.0.0.0", port=10087, reload=False)
